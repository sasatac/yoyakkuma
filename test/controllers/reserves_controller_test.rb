...
class ReservesControllerTest < ActionController::TestCase
  ...
  test "should create reserf" do
    assert_difference('Reserve.count') do
      post :create, reserf: { customer_id: @reserf.customer_id, end_datetime: @reserf.end_datetime, memo: @reserf.memo, start_datetime: @reserf.start_datetime, store_id: @reserf.store_id }
    end
  ...
  test "should update reserf" do
    patch :update, id: @reserf, reserf: { customer_id: @reserf.customer_id, end_datetime: @reserf.end_datetime, memo: @reserf.memo, start_datetime: @reserf.start_datetime, store_id: @reserf.store_id }
    assert_redirected_to reserf_path(assigns(:reserf))
  end
